<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"/www/wwwroot/Site-US/99/application/admin/view/system/sysbank.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811731;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                    ...
                    <section class="panel">
                        <div class="panel-body bio-graph-info">
                            ...
                            <form class="form-horizontal" role="form" method="post" id="formid">
                                <input type="hidden" value="<?php echo $sysbank['id']; ?>" name="id">
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">开户行</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="bank_name" value="<?php echo $sysbank['bank_name']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">开户网点</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="bank_addr" value="<?php echo $sysbank['bank_addr']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">开户人姓名</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="username" value="<?php echo $sysbank['username']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">银行卡号</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="card_no" value="<?php echo $sysbank['card_no']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script>
  function editcon(form){
    var bank_name = form.bank_name.value;
    var bank_addr = form.bank_addr.value;
    var username = form.username.value;
    var card_no = form.card_no.value;

    if(!bank_name){layer.msg('请输入开户行'); return false;}
    if(!username){layer.msg('请输入开户人姓名'); return false;}
    if(!card_no){layer.msg('请输入银行卡号'); return false;}

    var formurl = "<?php echo Url('system/sysbank'); ?>";
    var data = $('#formid').serialize();
    var locurl = "<?php echo Url('system/sysbank'); ?>";
