<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"/www/wwwroot/Site-US/99/application/admin/view/rates/userinvest.html";i:1693811784;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811731;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<section id="main-content">
    <section class="wrapper">
		<div class="row state-overview">
			<div class="container">
				<form action="<?php echo url('rates/userinvest'); ?>" method="get">
					<div class="row">
						<div class="col-lg-5 mar-10">
							<div class="input-group">
								<span class="input-group-addon" id="basic-addon1">用户名</span>
								<input type="text"  value="<?php echo !empty($getdata['username'])?$getdata['username']:''; ?>"  class="form-control" name="username" placeholder="用户名"/>
							</div>
						</div>
                    ...
                    <table class="table table-striped table-advance table-hover">
						...
						<!-- <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
							<tr>
								...
								<td><?php echo $amount_name_admin; ?><?php echo $vo['money']; ?></td>
								<td><?php echo $amount_name_admin; ?><?php echo $vo['interest']; ?></td>
								<td><?php echo $vo['days']; ?>天</td>
								<td><?php echo date("Y-m-d H:i:s",$vo['time']); ?></td>
								<td><?php if($vo['totime']>0): ?><?php echo date("Y-m-d H:i:s",$vo['totime']); else: ?>-<?php endif; ?></td>
								<td><?php if($vo['state']==2): ?>已回款<?php else: ?>未回款<?php endif; ?></td>
								<td><?php if($vo['state']==2): ?>-<?php else: ?>
										<a class="btn btn-danger btn-xs" onclick="interest('<?php echo $vo['id']; ?>')" title="点击回款"><i class="icon-gear"></i></a>
									<?php endif; ?>
								</td>
							</tr>
...
<script>
    ...
    function interest(id){
        layer.open({
            ...
            yes: function(index){
                //do something
                var url = "<?php echo url('rates/interest'); ?>"+"?id="+id;
                var locurl = "<?php echo Url('admin/rates/userinvest'); ?>"
                WPget(url,locurl);
            }
        });
    }
