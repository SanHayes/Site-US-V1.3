<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"/www/wwwroot/Site-US/99/application/admin/view/rates/add.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                      ...
                      <form class="form-horizontal" role="form" id="formid" method="post">
						  <section class="panel">
							  ...
							  <div class="panel-body bio-graph-info">
								  <h1> <?php echo !empty($item['pid'])?'编辑产品':'添加产品'; ?></h1>
									  
								  <input type="hidden" name="pid" value="<?php echo $item['pid']; ?>"/>
								  <input type="hidden" name="type" value="2"/>
								  
								  <div class="form-group">
									  <label class="col-lg-2 control-label">期货名称</label>
									  <div class="col-lg-4">
										  <select name="proid" class="selectpicker show-tick form-control" required>
												<?php if(is_array($prolist) || $prolist instanceof \think\Collection || $prolist instanceof \think\Paginator): $i = 0; $__LIST__ = $prolist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
												    <option <?php if($vo['pid'] == $item['pid']): ?>selected<?php endif; ?> value="<?php echo $vo['pid']; ?>"><?php echo $vo['Name']; ?></option>
								  ...
								  <div class="form-group">
									  ...
									  <div class="col-lg-5">
										  <input type="text" class="form-control" value="<?php echo $item['days']; ?>"  placeholder="请填写产品期限" name="days" required style="display: inline-block; width: 75%;"/> 天
									  </div>
								  </div>
								  ...
								  <div class="form-group">
									  ...
									  <div class="col-lg-4">
										  <select name="type" class="selectpicker show-tick form-control" required>
												...
												<option <?php if(isset($item) && $item['type'] == 1): ?>selected<?php endif; ?> value="1">分红</option>
												<option <?php if(isset($item) && $item['type'] == 2): ?>selected<?php endif; ?> value="2">利率</option>
										  </select>
									  </div>
								  </div>
								  -->
								  ...
								  <div class="form-group">
									  ...
									  <div class="col-lg-4">
									  		<input type="text" class="form-control" value="<?php echo $item['rates']; ?>"  placeholder="请填写产品利息" name="rates" required style="display: inline-block; width: 75%;"/> %
									  		<!--
											<div class="input-group">
												<input type="text" class="form-control" value="<?php echo $item['rates']; ?>"  placeholder="请填写产品利息" name="rates" required/>
											</div>
								  ...
								  <div class="form-group">
									  ...
									  <div class="col-lg-5">
										  <input type="text" class="form-control" value="<?php echo $item['min']; ?>"  placeholder="请填写起投金额" name="min" required style="display: inline-block; width: 75%;"/> 元
									  </div>
								  </div>
								  ...
								  <div class="form-group">
									  ...
									  <div class="col-lg-4">
										  <select name="state" class="selectpicker show-tick form-control" required>
												<option value="">请选择分类</option>
												<option <?php if(isset($item) && $item['state'] == 1): ?>selected<?php endif; ?> value="1">启用</option>
												<option <?php if(isset($item) && $item['state'] == 2): ?>selected<?php endif; ?> value="2">停用</option>
										  </select>
									  </div>
								  </div>
...
function editpro(form){
	...
	var formurl = "<?php echo Url('rates/add'); ?>"
	var data	= $('#formid').serialize();
	var locurl	= "<?php echo Url('admin/rates/invest'); ?>";
