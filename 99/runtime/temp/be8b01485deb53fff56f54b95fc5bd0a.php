<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"/www/wwwroot/Site-US/99/application/admin/view/setup/index.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811731;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
		          ...
		          <div class="panel-body bio-graph-info">
		              <form class="form-horizontal" role="form" action="<?php echo Url('editconf'); ?>" enctype="multipart/form-data" method="post" id="formid">
		                ...
		                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		                  <div class="form-group">
		                      ...
		                      <div class="col-lg-6">
		                        ...
		                        <div class="upload-pre-item"><a href="<?php echo $vo['value']; ?>" target="_blank" title="点击查看大图"><img height="100" src="<?php echo $vo['value']; ?>?v=<?php echo mt_rand(); ?>"></a></div><br>
								<?php endif; ?>
								<input type="hidden"  name="value_<?php echo $vo['id']; ?>_<?php echo $vo['type']; ?>">
								<input type="file" id="img_<?php echo $vo['id']; ?>" name="img_<?php echo $vo['id']; ?>">
								<?php elseif($vo['type'] == 4): ?>
                                <input type="hidden"  name="value_<?php echo $vo['id']; ?>_<?php echo $vo['type']; ?>">
								<input type="file" id="app_<?php echo $vo['id']; ?>" name="app_<?php echo $vo['id']; ?>">
		                        <?php endif; ?>
		                      </div>
						...
						<?php endforeach; endif; else: echo "" ;endif; ?>
		                  ...
		                  <div class="form-group" style="padding:5px;color:#1ea7cb">
		                      <p>默认送系统客服，若对客服不满意，可以替换成其他客服。</p>
		                      <p>系统客服链接： /kefu/php/app.php?widget-mobile </p>
		                      <p>pop800客服链接： https://wapi.pop800.com</p>
		                  </div>
		              </form>
		          </div>
		      </section>
