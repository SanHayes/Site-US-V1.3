<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"/www/wwwroot/Site-US/99/application/admin/view/user/addcard.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                              ...
                              <form class="form-horizontal" role="form" method="post" id="formid">
                                ...
                                <?php else: ?>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">持卡人UID</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="" name="uid" maxlength="10" required/>
                                      </div>
                                  </div>
                                <?php endif; ?>
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="<?php echo $item['accntnm']; ?>" name="accntnm" maxlength="10" required/>
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">所属银行</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="<?php echo $item['content']; ?>" name="content" maxlength="20" required/>
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">所属支行</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="<?php echo $item['address']; ?>" name="address" maxlength="20" required/>
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">卡号</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="<?php echo $item['accntno']; ?>" name="accntno" maxlength="19" required/>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="<?php echo $item['phone']; ?>" name="phone" maxlength="11" required/>
                                      </div>
                                  </div>
                                -->
...
<script>
	function editcon(form){		
      ...
      var formurl = "<?php echo Url('user/addcard'); ?>";
	    var locurl = "<?php echo Url('user/bankcard'); ?>";
