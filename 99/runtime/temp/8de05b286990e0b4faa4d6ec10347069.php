<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"/www/wwwroot/Site-US/99/application/admin/view/user/userinfo.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811731;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li <?php if($contrname == 'User' && ( in_array($actionname,array('userlist','useradd','userprice','bankcard','bankinfo','cash','myteam','chongzhi','blacklist','userinfo')) )): ?> class="active" <?php else: ?> class="sub-menu " <?php endif; ?>>
                      <a href="javascript:;" class="">
                          <i class="icon-user"></i>
                          <span>用户管理</span>
                          <span class="arrow"></span>
...
<!--main content start-->
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row state-overview">
                ...
                <div class="row">
                     ...
                     <div class="col-lg-6 mar-10">
                      ...
                      <div class="col-lg-3 mar-10">
                        <div class="input-group">
                            <span class="input-group-addon">初级认证</span>
                      ...
                      <div class="col-lg-3 mar-10">
                        <div class="input-group">
                            <span class="input-group-addon">高级认证</span>
              ...
              <!--state overview end-->
            <br><br>
            <a href="<?php echo url('user/userinfo'); ?>"><button type="submit" class="btn btn-danger">全部</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<?php echo url('user/userinfo',array('is_check'=>1)); ?>"><button type="submit" class="btn btn-danger">初级未审核</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<?php echo url('user/userinfo',array('up_check'=>1)); ?>"><button type="submit" class="btn btn-danger">高级未审核</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <br><br>
             <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <!-- <?php if(is_array($cardinfo) || $cardinfo instanceof \think\Collection || $cardinfo instanceof \think\Paginator): $i = 0; $__LIST__ = $cardinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td><?php echo intval($vo['id_type']) == 0?'身份证':'驾驶证'; ?></td>
                                  <td><?php echo $vo['name']; ?> </td>
                                  <td><?php echo $vo['card_id']; ?></td>
                                  <?php if($vo['front_pic']): ?>
                                  <td><a href="<?php echo $vo['front_pic']; ?>" target="_blank"><img width="35" height="35" src="<?php echo $vo['front_pic']; ?>"></a></td>
                                  <?php else: ?>
                                  <td></td>
                                  <?php endif; if($vo['reverse_pic']): ?>
                                  <td><a href="<?php echo $vo['reverse_pic']; ?>" target="_blank"><img width="35" height="35" src="<?php echo $vo['reverse_pic']; ?>"></a></td>
                                  <?php else: ?>
                                  <td></td>
                                  <?php endif; ?>
                                  ...
                                  <td>
                                      ...
                                      <button class="btn btn-primary btn-xs" onclick="return checkcard('<?php echo $vo['id']; ?>',2)">通过</button>
                                      <button class="btn btn-danger btn-xs" onclick="return checkcard('<?php echo $vo['id']; ?>',0)">拒绝</button>
                                      <?php elseif($vo['is_check'] == 2): ?>
                                      <span class="color_green">审核通过</span>
                                      <?php endif; ?>
                                  </td>
                                  <td>
                                      <?php if($vo['up_check'] == 1): ?>
                                      <button class="btn btn-primary btn-xs" onclick="return upcheckcard('<?php echo $vo['id']; ?>',2)">通过</button>
                                      <button class="btn btn-danger btn-xs" onclick="return upcheckcard('<?php echo $vo['id']; ?>',0)">拒绝</button>
                                      <?php elseif($vo['up_check'] == 2): ?>
                                      <span class="color_green">审核通过</span>
                                      <?php endif; ?>
                                  </td>
                              </tr>
...
function checkcard(id,type) {
	...
	layer.open({
	  ...
	  yes: function(index){
	    //do something
	    var formurl = "<?php echo Url('user/userinfo'); ?>";
		var data = 'id='+id+'&is_check='+type;
	    var locurl = "<?php echo Url('user/userinfo'); ?>";
