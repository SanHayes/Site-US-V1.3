<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"/www/wwwroot/Site-US/99/application/admin/view/user/bankcard.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row state-overview">
                <div class="container">
				        <form action="<?php echo url('user/bankcard'); ?>" method="get">
                <div class="row">
                      ...
                      <div class="col-lg-5 mar-10">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"  value="<?php echo !empty($getdata['username'])?$getdata['username']:''; ?>"  class="form-control" name="username" placeholder="uid/姓名/手机号/卡号"/>
                        </div>
                      </div>
			...
			<?php if($otype == 3): ?>
            <a href="<?php echo url('user/addcard'); ?>"><button type="submit" class="btn btn-danger">添加银行卡+</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
			<?php endif; ?>
            <br><br>
             ...
             <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <tbody>
                          <!-- <?php if(is_array($bankcard) || $bankcard instanceof \think\Collection || $bankcard instanceof \think\Paginator): $i = 0; $__LIST__ = $bankcard;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
								  ...
								  <?php if($otype == 3): ?>
                                  <td>
                                      <a href="<?php echo url('user/addcard',['id'=>$vo['id']]); ?>"><button class="btn btn-primary btn-xs">修改</button></a>
                                      <a href="javascript:;" onclick="delcard(<?php echo $vo['id']; ?>)"><button class="btn btn-danger btn-xs" >删除</button></a>
                                  </td>
								  <?php endif; ?>
                              </tr>
...
function delcard(id) {
  ...
  yes: function(index){
    var formurl = "<?php echo url('user/delcard'); ?>";
    var data = 'id='+id;
