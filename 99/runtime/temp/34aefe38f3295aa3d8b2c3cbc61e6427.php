<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"/www/wwwroot/Site-US/99/application/admin/view/rates/invest.html";i:1693811760;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811731;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
            ...
            <div class="col-lg-10">
                <section class="panel">
                    <header class="panel-heading">
                        <h4 class="left">利息产品</h4>
                        <a href="<?php echo url('rates/add'); ?>"><button type="button" class="btn btn-primary right">添加产品</button></a>
                        <br><br>
                    </header>
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if($vo['type'] == 1): ?> 分红 <?php else: ?> 利率 <?php endif; ?></td>
                                <td><?php if($vo['type'] == 1): ?> <?php echo $vo['rates']; ?>元 <?php else: ?> <?php echo $vo['rates']; ?>% <?php endif; ?></td>
                                <td><?php echo $amount_name_admin; ?><?php echo $vo['min']; ?></td>
                                <td><?php if($vo['state'] == 1): ?> 启用 <?php else: ?> 停用 <?php endif; ?></td>
                                <td>
                                      <a class="btn btn-primary btn-xs" href="<?php echo url('rates/add',array('pid'=>$vo['pid'])); ?>" title="点击编辑"><i class="icon-pencil"></i></a>
...
<script>
    ...
    function deleteinfo(pid){
        layer.open({
            ...
            yes: function(index){
                //do something
                var url = "<?php echo url('rates/delete'); ?>"+"?pid="+pid;
