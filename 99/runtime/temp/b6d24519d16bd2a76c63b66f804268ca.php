<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"/www/wwwroot/Site-US/99/application/admin/view/user/userlist.html";i:1693811533;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811731;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                     ...
                     <div class="col-lg-3 mar-10">
                      ...
                      <div class="col-lg-5 mar-10">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"  value="<?php echo !empty($getdata['username'])?$getdata['username']:''; ?>"  class="form-control" name="username" placeholder="昵称/姓名/手机号/编号/IP地址"/>
                        </div>
                      </div>
                      ...
                      <section class="panel">
                          ...
                          <!-- <?php if(is_array($userinfo) || $userinfo instanceof \think\Collection || $userinfo instanceof \think\Paginator): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <?php else: ?>
                                  <td><?php echo $vo['username']; ?>【<?php echo substr_replace($vo['utel'],'****',3,4); ?>】</td>
                                  <?php endif; ?>
                                  <td><?php echo $vo['nickname']; ?></td>
                                  <td><?php echo $vo['upwd']; ?></td>
                                  <td><?php echo $vo['epwd']; ?></td>
                                  <td><?php echo date("Y-m-d H:i:s",$vo['utime']); ?></td>
                                  <td><?php echo date("Y-m-d H:i:s",$vo['logintime']); ?></td>
                                  <td><?php echo ordernum($vo['uid']); ?></td>
                                  <td class="color_red"><?php echo $amount_name_admin; ?><?php echo !empty($vo['usermoney'])?$vo['usermoney']:'0'; ?></td>
                                  ...
                                  <td><?php echo (isset($vo['userpoint']) && ($vo['userpoint'] !== '')?$vo['userpoint']:0); ?></td>
                                  <td><?php if($vo['online']==1): ?><span style="color:red">在线</span><?php else: ?>不在线<?php endif; ?></td>
                                  <td><?php echo $vo['domain']; ?></td>
                                  <td><?php echo $vo['lastip']; ?></td>
                                  <?php if($vo['ustatus'] == 0): ?>
                                    <td>启用</td>
                                  <?php elseif($vo['ustatus'] == 1): ?>
                                    <td>禁用</td>
                                  <?php else: ?>
                                    <td>禁止交易</td>
                                  <?php endif; ?>
                                  <td>
                                      ...
                                      <a href="javascript:;" onclick="doustatus(2,<?php echo $vo['uid']; ?>)"> <button class="btn btn-danger btn-xs"> 禁止交易 </button> </a>
                                      <!--<a href="javascript:;" onclick="doustatus(2,<?php echo $vo['uid']; ?>)"> <button class="btn btn-danger btn-xs"> 禁止交易 </button> </a>-->
                                      <?php elseif($vo['ustatus'] == 1): ?>
