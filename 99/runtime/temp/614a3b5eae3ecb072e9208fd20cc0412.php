<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"/www/wwwroot/Site-US/99/application/admin/view/system/addrech.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                  ...
                  <div class="col-sm-12">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> 添加充值配置</h1>
                              <form class="form-horizontal" role="form" method="post" id="formid" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" name="pay_conf"  value="<?php echo !empty($pay_conf)?$pay_conf:''; ?>"  />
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea name="account_no"  class="form-control" cols="30" rows="10"><?php echo !empty($account_no)?$account_no:''; ?></textarea>
								  ...
								  <!--<div class="form-group">-->
									 ...
									 <!-- <div class="col-lg-6">										-->
										<!--<?php if($thumb): ?>-->
										<!--<div class="upload-pre-item"><a href="<?php echo $thumb; ?>" target="_block" title="点击查看大图"><img height="100" src="<?php echo $thumb; ?>" alt=""></a></div>-->
										<!--<?php endif; ?>-->
