<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"/www/wwwroot/Site-US/99/application/admin/view/user/useradd.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <select name="ustatus" class="selectpicker show-tick form-control">
                                          	  <option <?php if(isset($ustatus) && $ustatus == 0): ?> selected <?php endif; ?> value="0">正常</option>
                                          	  <option <?php if(isset($ustatus) && $ustatus == 1): ?> selected <?php endif; ?> value="1">冻结</option>
                                          	  <option <?php if(isset($ustatus) && $ustatus == 2): ?> selected <?php endif; ?> value="2">禁止交易</option>
                                          </select>
                                      </div>
                                  </div>
								 <?php endif; ?>
                                  ...
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">代理</label>
                                      <div class="col-lg-6">
                                          <select name="otype" class="selectpicker show-tick form-control">
                                          	  <option <?php if($uotype==101): ?> selected <?php endif; ?> value="101">是</option>
                                          	  <option <?php if($uotype==0): ?> selected <?php endif; ?> value="0">否</option>
                                          </select>
                                      </div>
                                  </div>
								 
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">每天首登彩金</label>
                                      <div class="col-lg-6">
                                          <select name="log_caijin" class="selectpicker show-tick form-control">
                                          	  <option <?php if($log_caijin==1): ?> selected <?php endif; ?> value="1">送</option>
                                          	  <option <?php if($log_caijin==0): ?> selected <?php endif; ?> value="0">不送</option>
                                          </select>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control"  value="<?php echo !empty($usermoney)?$usermoney:'0'; ?>" name="usermoney" disabled="true"/>
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">信用分</label>
                                      <div class="col-lg-6">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="" name="upwd" maxlength="18"/>
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">交易密码</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="" name="epwd" maxlength="18"/>
                                      </div>
                                  </div>
...
<script>
	...
	function editcon(form){
		...
		var epwd = form.epwd.value;

    if(upwd && upwd.length<6){
      layer.msg('登录密码为6-18位字符'); return false;
    }
    if(epwd && epwd.length<6){
      layer.msg('交易密码为6-18位字符'); return false;
    }
		...
		if(!nickname){
      layer.msg('请输入真实姓名'); return false;
    }		
