<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"/www/wwwroot/Site-US/99/application/admin/view/setup/notice.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
             ...
             <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <a href="<?php echo url('admin/setup/addnotice'); ?>"><button type="submit" class="btn btn-danger">添加公告+</button></a>
                          ...
                          <!-- <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td>
                                      <a href="<?php echo url('admin/setup/addnotice',['id'=>$vo['id']]); ?>"><button class="btn btn-primary btn-xs">修改</button></a>
                                      <a href="javascript:;" onclick="delnotice(<?php echo $vo['id']; ?>)"><button class="btn btn-danger btn-xs" >删除</button></a>
                                  </td>
                              </tr>
...
function delnotice(id) {
  ...
  yes: function(index){
    var formurl = "<?php echo url('admin/setup/delnotice'); ?>";
    var data = 'id='+id;
