<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"/www/wwwroot/Site-US/99/application/admin/view/goods/proadd.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811731;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                  ...
                  <div class="col-sm-12">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <form class="form-horizontal" role="form" action="<?php echo Url('goods/proadd'); ?>" enctype="multipart/form-data" method="post" id="formid">
                                  ...
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">产品图标</label>
                                      <div class="col-lg-8">
                                          <?php if($img): ?>
            		                        <div class="upload-pre-item"><a href="<?php echo $img; ?>" target="_blank" title="点击查看大图"><img height="100" src="<?php echo $img; ?>?v=<?php echo mt_rand(); ?>"></a></div><br>
            								<?php endif; ?>
            								<input class="form-control" type="file" id="pic_<?php echo $pid; ?>" name="pic_<?php echo $pid; ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                          ...
                                          <div class="alert alert-block alert-danger fade in" style="margin:10px 0 0 0 ">
                                               <strong>注意：</strong> 如时间为：1分、3分、5分、8分，则请用字母逗号将时间分开，如输入：1,3,5,8。必须为4个。
                                        </div>
                                      </div>
                                  </div>
                                  
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">时间玩法最小下注金额</label>
                                      <div class="col-lg-8">
                                          <input type="text" class="form-control" value="<?php echo !empty($promoney)?$promoney:''; ?>"  placeholder="请填写时间玩法最小下注金额" name="promoney">
                                          <div class="alert alert-block alert-danger fade in" style="margin:10px 0 0 0 ">
                                               <strong>注意：</strong> 如金额为：1000、3000、5000、10000，则请用字母逗号将时间分开，如输入：1000,3000,5000,10000。必须和时间对映
                                        </div>
                                      </div>
                                  </div>
...
<!--                                   <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">波动/盈亏%</label>
                                      <div class="col-lg-8">
                                          <input type="text" class="form-control" value="<?php echo !empty($proscale)?$proscale:''; ?>"  placeholder="请填写波动点" name="proscale">
                                          <div class="alert alert-block alert-danger fade in" style="margin:10px 0 0 0 ">
                                               <strong>注意：</strong> 波动多少点算盈亏1个点；可以设一个值；也可以根据时间个数，设置同样个数。
                                        </div>
                                      </div>
                                  </div>
