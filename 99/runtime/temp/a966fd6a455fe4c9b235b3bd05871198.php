<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/www/wwwroot/Site-US/99/application/admin/view/setup/addnotice.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <form class="form-horizontal" role="form" method="post" id="formid">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="<?php echo $item['title']; ?>" name="title" id="title" maxlength="255" required/>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <label><input type="radio" name="state" id="state" value="1" <?php if($item['state'] == 1): ?>checked<?php endif; ?> /> 启用 </label>
                                          <label><input type="radio" name="state" id="state" value="0" <?php if($item['state'] == 0): ?>checked<?php endif; ?> /> 停用 </label>
                                      </div>
                                  </div>
