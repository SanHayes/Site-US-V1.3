<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"/www/wwwroot/Site-US/99/application/admin/view/goods/prolist.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811731;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <form action="proorder" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($vo['isopen'] == 1): ?>
                                    <a class="btn btn-danger btn-xs" href="<?php echo url('goods/proisopen',array('pid'=>$vo['pid'],'isopen'=>0)); ?>" >点击休市</a>
                                  <!--  <a class="btn btn-danger btn-xs" onclick="isopen(0,<?php echo $vo['pid']; ?>)">点击休市</a> -->
                                    <?php else: ?>
                                    <a class="btn btn-success btn-xs" href="<?php echo url('goods/proisopen',array('pid'=>$vo['pid'],'isopen'=>1)); ?>" >点击开市</a>
