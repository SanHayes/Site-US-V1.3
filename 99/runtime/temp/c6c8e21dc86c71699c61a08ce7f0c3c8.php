<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"/www/wwwroot/Site-US/99/application/admin/view/user/blacklist.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811613;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row state-overview">
                <div class="container">
				<form id="formid" action="<?php echo url('user/addblack'); ?>" method="post">
                <div class="row">
             ...
             <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <tbody>
                          <!-- <?php if(is_array($blacklist) || $blacklist instanceof \think\Collection || $blacklist instanceof \think\Paginator): $i = 0; $__LIST__ = $blacklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
...
function editcon(form){
    ...
    if(!remarks){layer.msg('请输入备注'); return false;}
      ...
      var formurl = "<?php echo Url('user/addblack'); ?>";
      var data = $('#formid').serialize();
      locurl = "<?php echo Url('user/blacklist'); ?>";
...
function delcard(id) {
  ...
  yes: function(index){
    var formurl = "<?php echo url('user/delblack'); ?>";
    var data = 'id='+id;
