<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"/www/wwwroot/Site-US/99/application/admin/view/user/cash.html";i:1693811682;s:56:"/www/wwwroot/Site-US/99/application/admin/view/head.html";i:1689666956;s:56:"/www/wwwroot/Site-US/99/application/admin/view/menu.html";i:1693811613;s:56:"/www/wwwroot/Site-US/99/application/admin/view/foot.html";i:1689666956;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                      ...
                      <section class="panel">
                          ...
                          <!-- <?php if(is_array($balance) || $balance instanceof \think\Collection || $balance instanceof \think\Paginator): $i = 0; $__LIST__ = $balance;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td class="color_green"><?php echo $amount_name_admin; ?><?php echo $vo['bpprice']; ?></td>
                                  <?php if($conf['reg_par']>0): ?>
                                  <td><?php echo $amount_name_admin; ?><?php echo $vo['reg_par']; ?></td>
                                  <td class="color_red"><?php echo $amount_name_admin; ?><?php echo !empty($vo['realprice']) && $vo['realprice']>0?$vo['realprice']:$vo['bpprice']; ?></td>
                                  <?php endif; ?>
                                  <td><?php echo $amount_name_admin; ?><?php echo $vo['bpbalance']; ?></td>
                                  <td><?php echo !empty($vo['isshow']) && $vo['isshow']==1?'显示' : '隐藏'; ?></td>
                                  <td><?php echo $vo['remarks']; ?></td>
                                  <td><?php echo $vo['accntnm']; ?></td>
                                  <td><?php echo $vo['content']; ?></td>
                                  <td><?php echo $vo['accntno']; ?></td>
                                  <td><?php echo $vo['address']; ?></td>
                                  <?php if($vo['qrcode']): ?>
                                  <td><a href="<?php echo $vo['qrcode']; ?>" target="_blank"><img src="<?php echo $vo['qrcode']; ?>" width="35" height="35"/></a></td>
                                  <?php else: ?>
                                  <td></td>
                                  <?php endif; ?>
                                  <td><?php echo date("Y-m-d H:i:s",$vo['bptime']); ?></td>
                                  <td><?php if($vo['bptype'] == 1): ?>
                                      <?php echo $vo['remarks']; elseif($vo['isverified'] == 0 && $otype == 3): ?>
                                      <button class="btn btn-primary btn-xs price" data-toggle="modal" data-isver="<?php echo $vo['isverified']; ?>" data-bpid="<?php echo $vo['bpid']; ?>" data-userid="<?php echo $vo['uid']; ?>" data-target="#myModal">处理/拒绝</button>
...
<script>
    ...
    $(".order-error").click(function(){
        ...
        bpid = $(this).attr('data-bpid');
        isver = $(this).attr('data-isver');
        var formurl = "<?php echo Url('user/docasherror'); ?>";
    ...
    function dopay(type){
        ...
        console.log(content);
    	var formurl = "<?php echo Url('user/docash'); ?>";
